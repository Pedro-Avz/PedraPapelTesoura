...
public final class ActivityGame1v2Binding implements ViewBinding {
  ...
  @NonNull
  public static ActivityGame1v2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGame1v2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_game_1v2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGame1v2Binding bind(@NonNull View rootView) {
