...
public final class ActivityGameLagartoSpockBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGameLagartoSpockBinding(@NonNull ScrollView rootView,
      @NonNull TextView aplicativo1Tv, @NonNull TextView escolhaTv,
      @NonNull ImageView imgAplicativo1, @NonNull ImageView imgLagarto, @NonNull ImageView imgPaper,
      @NonNull ImageView imgScizor, @NonNull ImageView imgSpock, @NonNull ImageView imgStone,
  ...
  @NonNull
  public static ActivityGameLagartoSpockBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGameLagartoSpockBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_game_lagarto_spock, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGameLagartoSpockBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGameLagartoSpockBinding((ScrollView) rootView, aplicativo1Tv, escolhaTv,
          imgAplicativo1, imgLagarto, imgPaper, imgScizor, imgSpock, imgStone, jogarBt, linerLayout,
          binding_toolbarIn);
    }
